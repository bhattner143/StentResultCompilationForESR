...
stentMigration.MigrationSubPlotting(FigureNum1,
...
stentMigration.MigrationSubPlotting(FigureNum2,
...
# =============================================================================
MergeMeanMigrationInfoDictDry={**stent_P1491_1_Mig_Dry_60mm.MeanMigrationInfoDict,
                     **stent_P1491_1_Mig_4Scoop_60mm.MeanMigrationInfoDict,
                     **stent_P1491_1_Mig_6Scoop_60mm.MeanMigrationInfoDict,
                     **stent_P1491_1_Mig_8Scoop_60mm.MeanMigrationInfoDict}

MergeGradMeanMigrationInfoDictDry={**stent_P1491_1_Mig_Dry_60mm.GradMeanMigrationInfoDict,
                     **stent_P1491_1_Mig_4Scoop_60mm.GradMeanMigrationInfoDict,
                     **stent_P1491_1_Mig_6Scoop_60mm.GradMeanMigrationInfoDict,
                     **stent_P1491_1_Mig_8Scoop_60mm.GradMeanMigrationInfoDict}
#%%
...
ax6=stentMigration.MigrationPlotting(FigureNum6,
                                 MergeMeanMigrationInfoDictDry,
                                 FileList)
ax6.legend(['No bolus',
             '72 g.L$^{-1}$',
             '108 g.L$^{-1}$',
             '144 g.L$^{-1}$'],prop={'size': 5})
plt.show()
...
FileList=['TOF_Dry_60m_30mmpsAnchored0g',
         'TOF_4Scoop_60m_30mmpsAnchored0g',
          'TOF_6Scoop_60m_30mmpsAnchored0g',
          'TOF_8Scoop_60m_30mmpsAnchored0g']

FigureNum7=plt.figure(num=7,figsize=(2.25,1.6))
ax7=stentMigration.MigrationPlotting(FigureNum7,
                                 MergeMeanMigrationInfoDictDry,
                                 FileList)
ax7.legend(['No bolus',
             '72 g.L$^{-1}$',
...
FileList=['TOF_Dry_60m_40mmpsAnchored0g',
         'TOF_4Scoop_60m_40mmpsAnchored0g',
          'TOF_6Scoop_60m_40mmpsAnchored0g',
          'TOF_8Scoop_60m_40mmpsAnchored0g']

FigureNum8=plt.figure(num=8,figsize=(2.25,1.6))
ax8=stentMigration.MigrationPlotting(FigureNum8,
                                 MergeMeanMigrationInfoDictDry,
                                 FileList)
ax8.legend(['No bolus',
             '72 g.L$^{-1}$',
...
QSRMarkerArray=QSRMarkerTrajectory.ArrayDict['QSR_experiment_5Q_40mm20mmps_44ms_11'][:,[6,8]]
QSRMarkerArrayReshape=np.reshape(QSRMarkerArray,(-1,10),order='F')
QSRMarkerArrayReshapeMean=np.array([np.mean(QSRMarkerArrayReshape[:,0:5],axis=1),
                                    np.mean(QSRMarkerArrayReshape[:,6:],axis=1)]).T
...
QSRMarkerArrayGradient=np.gradient(QSRMarkerArrayFiltered1,
            QSRMarkerArrayFiltered2,
                      axis=0)

X1 , Y1 = np.meshgrid(QSRMarkerArrayFiltered2[0:610:50],QSRMarkerArrayFiltered1[0:610:50])
...
ax.annotate('',
            xy=(6.7, 48), xycoords='data',
            xytext=(8.7, 45), textcoords='data',
            size=5,
