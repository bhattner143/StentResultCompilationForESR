...
# Plotting together
# =============================================================================
fig, axes = plt.subplots(9,1, figsize=(7, 7), sharex=True, dpi=120)
...
stent_P1568_2_Mano_Dry.dataframe['ManometryReading1'].plot(ax=axes[3], color='r', title='Original Series')
stent_P1568_2_Mano_4scoop.dataframe['ManometryReading1'].plot(ax=axes[3], color='g', title='Original Series')
stent_P1568_2_Mano_8scoop.dataframe['ManometryReading1'].plot(ax=axes[3], color='b', title='Original Series')

stent_P1568_2_Mano_Dry.dataframe['ManometryReading2'].plot(ax=axes[4], color='r', title='Original Series')
stent_P1568_2_Mano_4scoop.dataframe['ManometryReading2'].plot(ax=axes[4], color='g', title='Original Series')
stent_P1568_2_Mano_8scoop.dataframe['ManometryReading2'].plot(ax=axes[4], color='b', title='Original Series')

stent_P1568_2_Mano_Dry.dataframe['ManometryReading3'].plot(ax=axes[5], color='r', title='Original Series')
stent_P1568_2_Mano_4scoop.dataframe['ManometryReading3'].plot(ax=axes[5], color='g', title='Original Series')
stent_P1568_2_Mano_8scoop.dataframe['ManometryReading3'].plot(ax=axes[5], color='b', title='Original Series')


#fig, axes = plt.subplots(3,1, figsize=(7, 7), sharex=True, dpi=120)
stent_P1568_4_Mano_Dry.dataframe['ManometryReading1'].plot(ax=axes[6], color='r', title='Original Series')
stent_P1568_4_Mano_4scoop.dataframe['ManometryReading1'].plot(ax=axes[6], color='g', title='Original Series')
stent_P1568_4_Mano_8scoop.dataframe['ManometryReading1'].plot(ax=axes[6], color='b', title='Original Series')

stent_P1568_4_Mano_Dry.dataframe['ManometryReading2'].plot(ax=axes[7], color='r', title='Original Series')
stent_P1568_4_Mano_4scoop.dataframe['ManometryReading2'].plot(ax=axes[7], color='g', title='Original Series')
stent_P1568_4_Mano_8scoop.dataframe['ManometryReading2'].plot(ax=axes[7], color='b', title='Original Series')

stent_P1568_4_Mano_Dry.dataframe['ManometryReading3'].plot(ax=axes[8], color='r', title='Original Series')
stent_P1568_4_Mano_4scoop.dataframe['ManometryReading3'].plot(ax=axes[8], color='g', title='Original Series')
stent_P1568_4_Mano_8scoop.dataframe['ManometryReading3'].plot(ax=axes[8], color='b', title='Original Series')
